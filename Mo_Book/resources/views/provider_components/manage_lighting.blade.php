...
@section('lighting_select','active')
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('lighting.ManageLightingProcess')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="pt-3">
                                                @if($image!='')
                                                    <a href="{{asset('storage/media/lighting/'.$image)}}" target="_blank"><img width="100px" src="{{asset('storage/media/lighting/'.$image)}}"/></a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
