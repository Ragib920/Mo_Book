                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form action="{{route('sound_system.ManageSound_systemProcess')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="pt-3">
                                                @if($image!='')
                                                    <a href="{{asset('storage/media/sound_system/'.$image)}}" target="_blank"><img width="100px" src="{{asset('storage/media/sound_system/'.$image)}}"/></a>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
